...
urlpatterns = [
    ...
    path('add_task_log/', dashboard_views.add_task_log, name='add_task_log'),
    path('update_task_status/', dashboard_views.update_task_status, name='update_task_status'),
    path('edit_task/', dashboard_views.edit_task, name='edit_task'),
