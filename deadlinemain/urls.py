...
urlpatterns = [
    ...
    path('api/dashboard_meta/', api_views.dashboard_meta, name='dashboard_meta'),
    path('api/dashboard_deadlines/', api_views.dashboard_deadlines, name='dashboard_deadlines'),
